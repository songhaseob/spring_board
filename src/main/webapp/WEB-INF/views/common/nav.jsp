    ...
    pageEncoding="UTF-8"%>
		...
		<nav class="main-header navbar navbar-expand navbar-white navbar-light">
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a href="/spring/paging" class="nav-link">HOME</a></li>
				<li class="nav-item d-none d-sm-inline-block"><a href="/spring/paging" class="nav-link">회원관리</a></li>
			</ul>
